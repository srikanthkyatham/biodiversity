...
const new_chemical_entity_research1 = ()=>
{
    ...
    <>
        <div className="flex flex-col items-center px-5 px-10 py-5 space-y-10 my-10 page-container" id="aboutus">
            ...
            <div>
                ...
                <p>
                If you are interested in scaffold or total synthesis, do not hesitate to get in touch with us for details. We are available on call at +91 9948872227 or you can even write to us at <a href="mailto:sales@diversitybiosciences.com">sales@diversitybiosciences.com.</a>.
                </p>
            </div>
...
export default new_chemical_entity_research1;