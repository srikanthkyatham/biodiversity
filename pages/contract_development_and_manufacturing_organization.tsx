...
export default function contract_development_and_manufacturing_organization()
{
        ...
        <div className="flex flex-col items-center px-5 px-10 py-5 space-y-10 my-10 page-container" id="aboutus">
            ...
            <div>
                ...
                <ul className="list-disc space-y-3 text-left text-black block px-10 py-2 rounded-md text-1xl font-normal">
                    <li>We have the expertise and resources necessary to address different development stages that occur before the drug manufacturing stage.</li>
                    <li>Our team possesses the potential to handle the design, production and examination stages of early drug creation.</li>
                    <li>Outsourcing your drug manufacturing tasks to Diversity Bio Sciences will give you access to cutting-edge resources and technology without investing a huge amount of money and time towards developing the right in-house infrastructure.</li>
                </ul>
            </div>
            ...
            <div>
                ...
                <div className="faqsection">
                    <h4>Is contract research and custom synthesis a service only meant for the large pharmaceutical companies?</h4>            
                    <p>
                    No, not at all. Such services are not meant for any individual industry or a set group of customers. As a CRO, Diversity Bio Sciences serves pharmaceutical companies of all sizes without differentiating between varied customer branches.
                    </p>
                </div>

                <div className="faqsection">
                    <h4>How can I benefit from outsourcing research activities to Diversity Bio Sciences? </h4>            
                    <p>
                    Outsourcing research activities to us means major improvement in product development. Other benefits of our services include saved costs, time and resources.
                    </p>
                </div>

                <div className="faqsection">
                    <h4>What to look for in a CRO? </h4>            
                    <p>
                    Things to look out for in a CRO include key competence, size, location, communication, trust, financial stability, track record and different certifications. Diversity Bio Sciences excels in all these fields.
                    </p>
                </div>

                <div className="faqsection">
                    <h4>What are the benefits of contract manufacturing? </h4>            
                    <p>
                    Several benefits of contract manufacturing include production cost minimization; more focus on sales efforts; superior quality products and easy market entry.
                    </p>
                </div>

                <div className="faqsection">
                    <h4>Will you give me all the information about the progress of my synthesis project? </h4>            
                    <p>
                    Yes, with Diversity Bio Sciences, you will get all updates about the progress of your synthesis assignment on a regular basis.
                    </p>
                </div>
