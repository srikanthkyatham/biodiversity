...
const ScaffoldContainer = () =>
{
    ...
    <div className="flex flex-col items-center px-5 px-10 py-5 space-y-10 my-10 page-container" id="aboutus">
        ...
        <div>
            ...
            <ul>
                <li>Customized chemicals</li>
                <li>Value added and fully customized synthesis</li>
                <li>Milligram to kilogram batch synthesis potential</li>
                <li>Project management and planning</li>
                <li>Process development and optimization</li>
                <li>Fully developed analytical and purification potentials</li>
            </ul>
        </div>
        <div style={{ "margin": "20px" }}>
            <p  style={{ "marginBottom": "15px" }}>Our custom synthesis fortes include:</p>
            <ul>
                <li>Small and large chemistry potentials</li>
                <li>Advanced analytical and synthetic platform</li>
                <li>Synthetic route optimization and design</li>
                <li>High efficiency and cost-effectiveness</li>
            </ul>
        </div>
